...
- DURATION CONSTRAINTS:
  * EVERY clip MUST be between {min_secs:g} and {max_secs:g} seconds long (ideal: 20–45s).
  * NEVER return the entire video as one clip unless the total video duration is under {max_secs:g} seconds.
  * For longer videos, you MUST select {min_clips} to {max_clips} distinct, high-energy clips rather than returning the whole video.
  * Clips MUST NOT exceed {max_secs:g} seconds under any circumstance.
